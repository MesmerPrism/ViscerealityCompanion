...
public sealed class SussexControllerBreathingProfileStore
{
    private readonly SussexControllerBreathingTuningCompiler _compiler;

    public SussexControllerBreathingProfileStore(
    ...
    public async Task<IReadOnlyList<SussexControllerBreathingProfileRecord>> LoadAllAsync(CancellationToken cancellationToken = default)
    {
    ...
    public Task<SussexControllerBreathingProfileRecord> CreateFromTemplateAsync(
        string profileName,
        string? notes = null,
    ...
    public async Task<SussexControllerBreathingProfileRecord> SaveAsync(
        string? existingPath,
        string profileName,
        string? notes,
    ...
    public async Task<SussexControllerBreathingProfileRecord> ImportAsync(
        string sourcePath,
        CancellationToken cancellationToken = default)
    {
        if (string.IsNullOrWhiteSpace(sourcePath))
        {
            throw new InvalidDataException("Select a Sussex controller-breathing profile JSON file to import.");
        }
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        {
            throw new InvalidDataException("Select a destination path for the exported Sussex controller-breathing profile.");
        }
    ...
    private async Task<SussexControllerBreathingProfileRecord> LoadRecordAsync(string path, CancellationToken cancellationToken)
    {
    ...
    {
        var trimmed = string.IsNullOrWhiteSpace(profileName) ? "sussex-controller-breathing-profile" : profileName.Trim().ToLowerInvariant();
        ...
        return string.IsNullOrWhiteSpace(slug)
            ? "sussex-controller-breathing-profile.json"
            : slug + ".json";
    }
