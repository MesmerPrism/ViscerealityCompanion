...
public sealed class StudyDataRecorderService
{
    ...
    [
        ...
        new("orbit", "orbit.radius_visual01", "unit01", ["study.orbit.radius_visual01"]),
        new("orbit", "orbit.radius_envelope_weight01", "unit01", ["study.orbit.radius_envelope_weight01"]),
        new("orbit", "orbit.radius_phase01", "unit01", ["study.orbit.radius_phase01"]),
        new("orbit", "orbit.radius_peak_active", "bool", ["study.orbit.radius_peak_active"]),
