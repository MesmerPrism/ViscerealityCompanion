...
public sealed class PublishedPreviewUpdateServiceTests
{
    ...
    public void TryParseAppInstallerVersion_reads_root_version()
    {
        var version = PublishedPreviewUpdateService.TryParseAppInstallerVersion(
            ...
            <AppInstaller xmlns="http://schemas.microsoft.com/appx/appinstaller/2018" Version="0.1.45.0">
              <MainPackage Name="MesmerPrism.ViscerealityCompanion" Version="0.1.45.0" />
            </AppInstaller>
            """);

        Assert.Equal("0.1.45.0", version);
    }

    [Theory]
    [InlineData("0.1.44.0", "0.1.45.0", true)]
    [InlineData("0.1.45.0", "0.1.45.0", false)]
    [InlineData("0.1.46.0", "0.1.45.0", false)]
    [InlineData("preview", "0.1.45.0", false)]
    ...
    {
        var status = PublishedPreviewUpdateService.BuildStatus("unpackaged", isPackaged: false, availableVersion: "0.1.45.0");
