...
public sealed class AppBuildIdentityTests
{
    ...
    {
        var processPath = @"C:\Program Files\WindowsApps\MesmerPrism.ViscerealityCompanion_0.1.43.0_x64__8wekyb3d8bbwe\ViscerealityCompanion.App\ViscerealityCompanion.exe";
